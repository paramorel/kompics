...
public class Epfd extends ComponentDefinition {
	...
	private Handler<CheckTimeout> handleCheckTimeout = new Handler<CheckTimeout>() {
		...
		public void handle(CheckTimeout event) {
			...
			for (Address node : nodes) {
				...
				HeartbeatRequestMessage hbRequestMsg = new HeartbeatRequestMessage(
						self, sequenceNumber);
	...
	private Handler<HeartbeatRequestMessage> handleHbRequests = new Handler<HeartbeatRequestMessage>() {
	...
	private Handler<HeartbeatReplyMessage> handleHbReplies = new Handler<HeartbeatReplyMessage>() {
